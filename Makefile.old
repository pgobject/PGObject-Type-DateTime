# This Makefile is for the PGObject::Type::DateTime extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/PGObject/Type/DateTime.pm]
#     AUTHOR => [q[Chris Travers <chris.travers@gmail.com>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     LICENSE => q[BSD]
#     NAME => q[PGObject::Type::DateTime]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0] }
#     VERSION_FROM => q[lib/PGObject/Type/DateTime.pm]
#     clean => { FILES=>q[PGObject-Type-DateTime-*] }
...
NAME_SYM = PGObject_Type_DateTime
VERSION = 0.01
...
MAKE = make
FULLEXT = PGObject/Type/DateTime
BASEEXT = DateTime
PARENT_NAME = PGObject::Type
DLBASE = $(BASEEXT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/PGObject/Type/DateTime.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/PGObject/Type
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/PGObject/Type
...
TO_INST_PM = lib/PGObject/Type/DateTime.pm

PM_TO_BLIB = lib/PGObject/Type/DateTime.pm \
...
DISTNAME = PGObject-Type-DateTime
DISTVNAME = PGObject-Type-DateTime-0.01
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/PGObject/Type/DateTime.pm $(INST_MAN3DIR)/PGObject::Type::DateTime.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''DateTime Wrappers for PGObject'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: PGObject-Type-DateTime' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "DateTime Wrappers for PGObject",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "PGObject-Type-DateTime",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>DateTime Wrappers for PGObject</ABSTRACT>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/PGObject/Type/DateTime.pm blib/lib/PGObject/Type/DateTime.pm 
